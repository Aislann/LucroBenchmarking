...
const GestaoProdutos = () => {
  ...
  function QuadradoPreenchido({ margemLucro }) {
    ...
    return <div className='margem100' style={estiloQuadrado}>{calcularMargemLucro(dadosDaApi.find(item => item.idProduto === 9001).preco, valorPagoFornecedor).margemLucro}%</div>;
  }
